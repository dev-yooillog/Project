...
데이터 분석 학습 및 실무 경험을 정리한 포트폴리오 repo입니다.
...
| 프로젝트 | 설명 | 주요 기술 |
|----------|------|-----------|
| [Ad](#ad) Ad Click Prediction System | 광고 클릭 예측 (Accuracy 96.5%, AUC 0.993) | Python, scikit-learn |
| [Covid19](#covid19) COVID-19 Pandemic Spread Forecast | 5개국 코로나19 확산 분석 및 예측 | Python, ARIMA, LSTM |
| [Game](#game) AI 기반 보드게임 추천 시스템 | 보드게임 추천 시스템 + 모델 경량화 | Python, PyTorch |
